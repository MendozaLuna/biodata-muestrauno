        ...
        try:
            ...
            if not res_df.empty:
                ...
                with col_info:
                    ...
                    st.markdown(f'<a href="https://api.whatsapp.com/send?text=BioData:%20{mejor["Nombre"]}%20ofrece%20{n_est}%20por%20${int(mejor["Precio"])}" target="_blank" class="btn-share">📢 COMPARTIR OPCIÓN</a>', unsafe_allow_html=True)
